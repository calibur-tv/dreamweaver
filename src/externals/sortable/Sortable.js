...
Sortable.prototype = /** @lends Sortable.prototype */ {
	...
	_onDragOver: function (/**Event*/evt) {
		...
		if (activeSortable && !options.disabled &&
			...
			const ghostIsFirst = _ghostIsFirst(evt, vertical, this)
			if (
				!elLastChild ||
				// (lastChild(this.el, this.options.draggable) && _ghostIsLast(evt, vertical, this)) &&
			...
			} else if (ghostIsFirst === null) {
				return
			} else if (ghostIsFirst) {
...
function _ghostIsFirst(evt, vertical, sortable) {
	const child = getChild(sortable.el, 0, sortable.options)
	if (!child) {
		return null
	}
